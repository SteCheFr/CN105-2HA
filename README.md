...
🟢 If you want to modify the script yourself (Config_ESP32.yaml), [Click here](Documentation/Modifications_by_yourself.pdf) to read Documentation/Modifications_by_yourself.pdf
