...
🟢 If you want to modify the script yourself (Config_ESP32.yaml), [Read Documentation/Modifications_by_yourself.pdf](Documentation/Modifications_by_yourself.pdf)
